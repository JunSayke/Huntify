...
def ownership_required(get_object_func, owner_field, redirect_url=settings.HOME_URL, allow_staff=False, allow_superuser=False):
    """
    ...
    def decorator(view_func):
        ...
        def _wrapped_view(request, *args, **kwargs):
            ...
            if current_user != object_owner and not (allow_superuser and current_user.is_superuser) and not (
                    allow_staff and current_user.is_staff):
