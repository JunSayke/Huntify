    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('boarding_room', 'Boarding Room'), ('boarding_house', 'Boarding House')], default='boarding_room', max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='BoardingHouse',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact_number', models.CharField(max_length=20, validators=[django.core.validators.RegexValidator(message="Phone number must be entered in the format: '09XXXXXXXXX'. Up to 11 digits allowed.", regex='^09\\d{9}$')])),
