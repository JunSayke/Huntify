"""
Django settings for huntify_project project.
...
SECRET_KEY = 'django-insecure-by-$gm)g0k&=zo1w^7)8owcjo=7e3qp7@fm8e0_ktth!4lqx-0'
...
LOGIN_REDIRECT_URL = 'authentication:home'  # new
...
MIDDLEWARE = [
    ...
    "django_browser_reload.middleware.BrowserReloadMiddleware",  # tailwindcss
...
WSGI_APPLICATION = 'huntify_project.wsgi.application'
